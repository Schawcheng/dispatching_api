...
urlpatterns = [
    ...
    path('agents/<int:agent_id>/points/', views.AgentPointsView.as_view()),
    path('agents/<int:agent_id>/parent/', views.AgentParentView.as_view()),
    path('agents/<int:agent_id>/lv1-rate/', views.AgentLv1RateView.as_view()),
    path('agents/<int:agent_id>/lv2-rate/', views.AgentLv2RateView.as_view()),
    path('agents/<int:agent_id>/lv3-rate/', views.AgentLv3RateView.as_view()),
    path('agents/<int:agent_id>/password/', views.AgentPasswordView.as_view()),
    ...
    path('cards/calculation/', views.CardRateCalculation.as_view()),
